...
- Who it's for
- What pain it solves
- Observable buying signals that indicate this offer is relevant
- What the client gets (deliverables)
- What you actually do, step by step (delivery methodology)
- Required access and tools
- Skills you need
- A "Can I deliver this?" self-assessment checklist
- Delivery risk level
- Suggested starter price range
- What proof/content can come from it (YouTube case studies, LinkedIn posts)
...
These are starter price ranges for a first client. The goal is to get your first paid engagement, not to maximize price. Once you have one case study, you can raise prices 30–50%. Price by outcome and speed, not by hour.

## The productized service pricing ladder (for reference)
